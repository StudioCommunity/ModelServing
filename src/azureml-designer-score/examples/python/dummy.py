...
from azureml.designer.score.python_score_module import *
from azureml.designer.score import ioutil
...
if __name__ == '__main__':
    ...
    azureml.designer.modelspec.python.save_model(model, model_path)

    model1 = azureml.designer.modelspec.python.load_model(model_path)
