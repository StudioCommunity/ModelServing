...
def save_as_datatable(df, output_path):
    from azureml.designer.common.datatypes import DataTypes
    from azureml.designer.common.datatable.data_table import DataTable
    from azureml.designer.modulehost.handler.port_io_handler import OutputHandler
