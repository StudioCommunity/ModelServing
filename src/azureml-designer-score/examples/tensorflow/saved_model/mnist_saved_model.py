...
from azureml.designer.modelspec.tensorflow import save_model
...
def main(_):
  ...
  # using azureml.designer.modelspec to save model
  save_model(sess, [x], [y], path = FLAGS.export_dir)
  print('Done exporting!')


# python -m examples.tensorflow.saved_model.mnist_saved_model --export_dir=model/tensorflow-minist-saved-model/
