...
from azureml.studio.score.python_score_module import *
...
if __name__ == '__main__':
    ...
    azureml.studio.modelspec.python.save_model(model, model_path)

    model1 = azureml.studio.modelspec.python.load_model(model_path)
