...
def get_requirements() -> list:
    ...
    """
    exclude = ('pytest', 'pylint', 'torch', 'torchvision', 'azureml.core', 'azureml-designer-internal', 'azureml-designer-classic-modules', 'azureml.contrib.services', 'azureml-designer-model', 'azureml-dataprep[pandas,fuse]', 'azureml-designer-core[image]', 'git+https://github.com/chjinche/CustomModules-1.git@master#subdirectory=azureml-custom-module-examples/image-classification')
