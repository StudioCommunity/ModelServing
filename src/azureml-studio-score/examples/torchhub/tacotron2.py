...
class Tacotron2Model(azureml.studio.modelspec.python.PythonModel):
...
if __name__ == '__main__':
    ...
    #azureml.studio.modelspec.python.save_model(model, model_path, github = github, module_path = module, model_class= model_class)

    model1 = azureml.studio.modelspec.python.load_model(model_path, github = github, module_path = module, model_class= model_class, force_reload= True)
